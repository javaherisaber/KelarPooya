    ...
    public void format(SearchView searchView) {
        ...
        if (mSearchTextColorResource != 0) {
            if (Build.VERSION.SDK_INT >= 23) {
                view.setTextColor(mResources.getColor(mSearchTextColorResource,null));
            }else {
        ...
        if (mSearchHintColorResource != 0) {
            if (Build.VERSION.SDK_INT >= 23) {
                view.setHintTextColor(mResources.getColor(mSearchHintColorResource,null));
            }else {
        ...
        if (mSearchIconResource != 0) {
            ...
            if (mSearchIconInside) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    searchIconDrawable = mResources.getDrawable(mSearchIconResource,null);
                }else {
